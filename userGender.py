def userGender():
    ...
    # Print the results
    result1 = f"{maleUser[0][0] / (maleUser[0][0] + femaleUser[0][0]) * 100:.2f}% of the users are male."
    result2 = f"{femaleUser[0][0] / (maleUser[0][0] + femaleUser[0][0]) * 100:.2f}% of the users are female."
